export const CUBE_MAP = {
  ...
  7: {
    ...
    row: 0,
    col: 1,
    obstacle: { value: "orange", color: "FFA500", id: "22", collectedBy: "3" },
    player: null,
  },
  8: {
    surface: 1,
  ...
  9: { surface: 1, row: 0, col: 3, obstacle: null, player: null },
  10: { surface: 1, row: 0, col: 4, obstacle: null, player: null },
  ...
  24: { surface: 1, row: 1, col: 3, obstacle: null, player: null },
  25: {
    surface: 1,
    row: 1,
    col: 4,
    obstacle: { value: "yellow", color: "FFFF00", id: "89", collectedBy: null },
    player: null,
  },
  ...
  36: {
    ...
    player: {
      id: "3",
      current: 36,
      lastPassedByObstacles: { 92: { tileNum: 78 } },
      goal: 188,
  ...
  37: { surface: 1, row: 2, col: 1, obstacle: null },
  38: { surface: 1, row: 2, col: 2, obstacle: null },
  ...
  51: { surface: 1, row: 3, col: 0, obstacle: null, player: null },
  52: { surface: 1, row: 3, col: 1, obstacle: null, player: null },
  53: {
    surface: 1,
    row: 3,
    col: 2,
    obstacle: { value: "blue", color: "0000FF", id: "53", collectedBy: null },
  },
  54: {
    surface: 1,
    row: 3,
  ...
  55: { surface: 1, row: 3, col: 4, obstacle: null, player: null },
  ...
  66: { surface: 1, row: 4, col: 0, obstacle: null, player: null },
  67: { surface: 1, row: 4, col: 1, obstacle: null, player: null },
  68: {
    surface: 1,
    row: 4,
    col: 2,
  ...
  70: { surface: 1, row: 4, col: 4, obstacle: null, player: null },
  ...
  76: { surface: 3, row: 0, col: 0, obstacle: null, player: null },
  77: {
    surface: 3,
    row: 0,
    col: 1,
    obstacle: { value: "red", color: "FF0000", id: "92", collectedBy: null },
    player: null,
  },
  78: {
    surface: 3,
  ...
  80: {
    ...
    row: 0,
    col: 4,
    obstacle: { value: "yellow", color: "FFFF00", id: "80", collectedBy: null },
    player: null,
  },
  81: {
    surface: 4,
  ...
  91: { surface: 3, row: 1, col: 0, obstacle: null, player: null },
  92: {
    surface: 3,
    row: 1,
    col: 1,
  ...
  98: {
    ...
    row: 1,
    col: 2,
    obstacle: { value: "blue", color: "0000FF", id: "98", collectedBy: null },
    player: null,
  },
  99: {
    surface: 4,
  ...
  101: { surface: 5, row: 1, col: 0, obstacle: null, player: null },
  102: { surface: 5, row: 1, col: 1, obstacle: null, player: null },
  ...
  110: { surface: 3, row: 2, col: 4, obstacle: null, player: null },
  111: { surface: 4, row: 2, col: 0, obstacle: null, player: null },
  ...
  116: { surface: 5, row: 2, col: 0, obstacle: null, player: null },
  117: { surface: 5, row: 2, col: 1, obstacle: null, player: null },
  118: { surface: 5, row: 2, col: 2, obstacle: null, player: null },
  119: {
    surface: 5,
    row: 2,
    col: 3,
    obstacle: { value: "red", color: "FF0000", id: "119", collectedBy: null },
    player: null,
  },
  120: {
    surface: 5,
  ...
  128: { surface: 4, row: 3, col: 2, obstacle: null, player: null },
  129: { surface: 4, row: 3, col: 3, obstacle: null, player: null },
  130: {
    surface: 4,
    row: 3,
    col: 4,
    obstacle: { value: "green", color: "008000", id: "131", collectedBy: null },
    player: null,
  },
  131: {
    surface: 5,
  ...
  141: { surface: 4, row: 4, col: 0, obstacle: null, player: null },
  142: { surface: 4, row: 4, col: 1, obstacle: null, player: null },
  ...
  147: { surface: 5, row: 4, col: 1, obstacle: null, player: null },
  148: { surface: 5, row: 4, col: 2, obstacle: null, player: null },
  149: { surface: 5, row: 4, col: 3, obstacle: null, player: null },
  150: { surface: 5, row: 4, col: 4, obstacle: null, player: null },
  ...
  158: { surface: 7, row: 0, col: 2, obstacle: null, player: null },
  159: { surface: 7, row: 0, col: 3, obstacle: null, player: null },
  160: { surface: 7, row: 0, col: 4, obstacle: null, player: null },
  ...
  173: { surface: 7, row: 1, col: 2, obstacle: null, player: null },
  174: { surface: 7, row: 1, col: 3, obstacle: null, player: null },
  175: { surface: 7, row: 1, col: 4, obstacle: null, player: null },
  ...
  186: { surface: 7, row: 2, col: 0, obstacle: null, player: null },
  187: { surface: 7, row: 2, col: 1, obstacle: null, player: null },
  188: { surface: 7, row: 2, col: 2, obstacle: null, player: null },
  189: {
    surface: 7,
    row: 2,
    col: 3,
    obstacle: { value: "green", color: "008000", id: "190", collectedBy: null },
    player: null,
  },
  190: {
    surface: 7,
  ...
  201: { surface: 7, row: 3, col: 0, obstacle: null, player: null },
  202: { surface: 7, row: 3, col: 1, obstacle: null, player: null },
  203: { surface: 7, row: 3, col: 2, obstacle: null, player: null },
  204: {
    surface: 7,
    row: 3,
    col: 3,
  ...
  220: { surface: 7, row: 4, col: 4, obstacle: null, player: null },
